  ...
  return (
    <div className="flex flex-col items-center">
      ...
      <img
        ...
        className="w-1/2 mt-6 rounded-xl shadow-lg"
        alt="Barbería"
      />
      <h3 className="mt-8 text-2xl font-bold">Barberos</h3>
            <div className="flex flex-col gap-2 p-8 sm:flex-row sm:items-center sm:gap-6 sm:py-4 bg-white rounded-xl shadow-md mt-4 w-1/2">
        <img
        ...
        <div className="space-y-2 text-center sm:text-left">
          <div>
            ...
            <h3 className="font-medium text-gray-500">Barbero</h3>
          </div>
